...
pub fn report_to_text(report: &ExperimentReport) -> String {
    ...
    out.push_str("  Raw UTF-8 findings are diagnostic only unless supported by linguistic encodings. v0.2 adds bit_text, Markov nulls, gap-order controls, and explicit hyphen policy.\n");
    out
}
